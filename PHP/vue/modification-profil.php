                    ...
                    <div class="row text-center" style="margin-bottom:10px;">
                        ...
                        <div class="col-md-6">
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" name="inputVille" value="<?php print recupCodePostalIdVille($profil->idVille) ?>" id="inputVille" class="form-control" placeholder="Code Postal" required autofocus>
                            </div>
                        </div>
                    </div>
                </div>
