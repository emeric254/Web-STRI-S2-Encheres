            ...
            <div class="container">
                <h4>
                    <span class="label label-danger">
                        <a href="/?page=gestionBd&action='supprimerVente'&idAction=<?php print $vente->id; ?>" onclick="if(confirm('Etes vous sur de vouloir retirer votre vente ?')) document.location.href = this.href + '?verified' ; return false;">
...
?>
            <div class="container">
                <h4>
                    <span class="label label-danger">
                        <a href="/?page=gestionBd&action='supprimerVente'&idAction=<?php print $vente->id; ?>" onclick="if(confirm('Etes vous sur de vouloir retirer cette vente ?')) document.location.href = this.href + '?verified' ; return false;">
                            <i class="fa fa-trash-o"></i>
                            Retirer cette vente
                        </a>
                    </span>
